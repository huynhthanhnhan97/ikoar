...
THREE.OrbitControls = function(object, domElement) {
    ...
    //     scope.deviceAcceleration = event.acceleration;
    // }
    ...
    this.update = function() {
        ...
        return function update() {
            ...
            // var deltaPosX = 1 / 2 * scope.deviceAcceleration.x;
            // var deltaPosY = 1 / 2 * scope.deviceAcceleration.y;
            // var deltaPosZ = 1 / 2 * scope.deviceAcceleration.z;
            // if (deltaPosX && deltaPosY)
            //     scope.object.position.x += deltaPosX;
            // console.log(deltaPosX), scope.object.position.x;
